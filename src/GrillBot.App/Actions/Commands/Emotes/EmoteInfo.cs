...
public class EmoteInfo : CommandAction
{
    ...
    private Embed CreateEmbed(Emote emote, EmoteStatItem statistics, IGuild? guild, IEnumerable<string> topTen)
    {
        ...
        return new EmbedBuilder()
            ...
            .AddField(Texts["Emote/Info/Embed/Fields/FirstOccurence", Locale], statistics.FirstOccurence.ToCzechFormat(), true)
            .AddField(Texts["Emote/Info/Embed/Fields/LastOccurence", Locale], statistics.LastOccurence.ToCzechFormat(), true)
