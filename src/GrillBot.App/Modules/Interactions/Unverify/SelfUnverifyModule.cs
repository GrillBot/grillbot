...
[RequireUserPerms]
public class SelfUnverifyModule(IServiceProvider serviceProvider) : InteractionsModuleBase(serviceProvider)
{
    ...
    )
    {
        ...
        try
        {
            ...
            var toKeep = keepables.Split([',', ';', ' '], StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries).Select(o => o.ToUpper()).ToList();
