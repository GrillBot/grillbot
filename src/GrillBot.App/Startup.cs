...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddQuartz(q =>
        {
            ...
            q.AddJob<AuditLogFilesMigrationJob>(opt => opt.WithIdentity(nameof(AuditLogFilesMigrationJob)))
                .AddTrigger(t => t.ForJob(nameof(AuditLogFilesMigrationJob)).StartNow());
