...
public class ServicePointsIncrementTests : ApiActionTest<ServiceIncrementPoints>
{
    ...
    protected override ServiceIncrementPoints CreateInstance()
    {
    ...
    public async Task ProcessAsync_UserNotFound()
        => await Instance.ProcessAsync(Consts.GuildId + 1, Consts.UserId, 100);
    ...
    public async Task ProcessAsync_Success()
    {
        ...
        await Instance.ProcessAsync(Consts.GuildId, Consts.UserId, amount);
