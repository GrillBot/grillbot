...
public class GetCurrentUnverifiesTests : ApiActionTest<GetCurrentUnverifies>
{
    ...
    protected override GetCurrentUnverifies CreateAction()
    {
        ...
        var unverifyService = new UnverifyService(unverifyChecker, unverifyProfileGenerator, unverifyLogger, DatabaseBuilder, loggingManager, messageGenerator, client);
