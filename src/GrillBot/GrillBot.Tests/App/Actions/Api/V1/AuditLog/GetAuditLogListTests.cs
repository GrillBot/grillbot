...
public class GetAuditLogListTests : ApiActionTest<GetAuditLogList>
{
    ...
    private async Task InitAllTypesAsync()
    {
        ...
        var items = new (AuditLogItemType, object)[]
        {
            ...
            (AuditLogItemType.MemberUpdated, new MemberUpdatedData { Target = new AuditUserInfo { Id = Consts.UserId + 1 } }),
            (AuditLogItemType.MemberRoleUpdated, new MemberUpdatedData { Target = new AuditUserInfo { Id = Consts.UserId + 1 } }),
